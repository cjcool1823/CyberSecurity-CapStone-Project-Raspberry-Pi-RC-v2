...
picam2.preview_configuration.main.format = "BGR888"  # FIXED: Use BGR format for OpenCV
...
for _ in range(30):
    ...
    cv2.imshow("Camera Preview", frame)  # FIXED: No color conversion needed
    cv2.waitKey(100)
...
try:
    while True:
        ...
        # FIXED: No color conversion needed
